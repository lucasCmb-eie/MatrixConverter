...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of AXI_Promediador_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AXI_Promediador_0/S0_AXI_PROMEDIOS]
	connect_bd_net [get_bd_pins AXI_Promediador_0/s0_axi_promedios_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_Promediador_0/s0_axi_promedios_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to AXI_Promediador_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AXI_Promediador_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI_Promediador_0_S0_AXI_PROMEDIOS_* ]]
	puts $fp "set s0_axi_promedios_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:AXI_Promediador:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AXI_Promediador_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXI_Promediador_hw_${i}"
