...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of AXI_SVM_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AXI_SVM_0/S0_AXI_PARAMETROS]
	connect_bd_net [get_bd_pins AXI_SVM_0/s0_axi_parametros_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_SVM_0/s0_axi_parametros_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins AXI_SVM_0/S1_AXI_CTRL_MUESTREO]
	connect_bd_net [get_bd_pins AXI_SVM_0/s1_axi_ctrl_muestreo_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_SVM_0/s1_axi_ctrl_muestreo_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of AXI_SVM_0 streaming interfaces..
	connect_bd_net [get_bd_pins AXI_SVM_0/m0_axis_tensiones_entrada_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXI_SVM_0/m0_axis_tensiones_entrada_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to AXI_SVM_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AXI_SVM_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI_SVM_0_S0_AXI_PARAMETROS_* ]]
	puts $fp "set s0_axi_parametros_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AXI_SVM_0_S1_AXI_CTRL_MUESTREO_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AXI_SVM_hw_test.tcl
