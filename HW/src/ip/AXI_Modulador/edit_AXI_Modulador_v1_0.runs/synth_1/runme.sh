...
HD_PWD='F:/Proyecto_Final/repo/FinalProject_Ing/HW/src/ip/AXI_Modulador/edit_AXI_Modulador_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Modulador_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Modulador_v1_0.tcl
